...
class Mad_Import_Data_Store {
	...
	private $stores = array(
		...
		'product'               => 'Mad_Import_Product_Data_Store_CPT',
	...
	// 	$this->stores      = apply_filters( 'mad_import_data_stores', $this->stores );
	...
	// 	if ( array_key_exists( $object_type, $this->stores ) ) {
	// 		$store = apply_filters( 'mad_import_' . $object_type . '_data_store', $this->stores[ $object_type ] );
	// 		if ( is_object( $store ) ) {
	// 			throw new Exception( __( 'Invalid data store.', 'ssv' ) );
	...
	public static function load( $object_type ) {
		return new Mad_Import_Data_Store( $object_type );
	}
