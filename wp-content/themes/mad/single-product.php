        ...
        <div class="box-gallery__right">
          <div class="box-gallery__content">
            ...
            <div class="box-gallery__link">
                <a href="" class="btn js-lightbox-form"><?php _e( 'Enquire Now', 'ssvmad' ); ?></a>  <a class="btn btn--icon icon-share share-custom"><?php echo _e( 'SHARE', 'ssvmad' ); ?></a><div class="sharethis-inline-share-buttons"></div>
            </div>
        </div>
      </div>
    </div>
